<?php
	namespace Back\Modulos\Achatamento;
	...
	use Back\Modulos\Anexos\Anexos;
			...
			if ( $vStatSess[ 'status' ] == 'aberto' ) {
				...
				try{
					...
					$GetRegMeta = str_replace(
						':FILTRO',
						'( amos_achat_cada_iden LIKE :amos_achat_cada_iden )', 
						self::$RotSql[ 'GetRegAchat' ]
					);
					...
					$listreg = Core::SetGeraPdf(
						$Cabecalho,
						$Corpo,
						str_replace( array( 'Back\Modulos\Achatamento', 'Back/Modulos/Achatamento' ), '', __DIR__ ).'Imagem/'.$Retorno[0]['sis_para_logo'],
						'P',
						'SIMPLES',
						array( 10, 40, 10, 5 )
					);
