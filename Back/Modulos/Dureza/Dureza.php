			...
			if ( $vStatSess[ 'status' ] == 'aberto' ) {
				...
				try{
					...
					$GetRegMeta = str_replace(
						':FILTRO',
						'( amos_dure_cada_iden LIKE :amos_dure_cada_iden )', 
						self::$RotSql[ 'GetRegDure' ]
					);
					...
					$listreg = Core::SetGeraPdf(
						$Cabecalho,
						$Corpo,
						str_replace( array( 'Back\Modulos\Dureza', 'Back/Modulos/Dureza' ), '', __DIR__ ).'Imagem/'.$Retorno[0]['sis_para_logo'],
						'P',
						'SIMPLES',
						array( 10, 40, 10, 5 )
					);
