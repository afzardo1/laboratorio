<?php
	namespace Back\Modulos\Dobramento;
			...
			if ( $vStatSess[ 'status' ] == 'aberto' ) {
				...
				try{
					...
					$GetRegMeta = str_replace(
						':FILTRO',
						'( amos_dobra_cada_iden LIKE :amos_dobra_cada_iden )', 
						self::$RotSql[ 'GetRegDobra' ]
					);
					...
					$listreg = Core::SetGeraPdf(
						$Cabecalho,
						$Corpo,
						str_replace( array( 'Back\Modulos\Dobramento', 'Back/Modulos/Dobramento' ), '', __DIR__ ).'Imagem/'.$Retorno[0]['sis_para_logo'],
						'P',
						'SIMPLES',
						array( 10, 40, 10, 5 )
					);
