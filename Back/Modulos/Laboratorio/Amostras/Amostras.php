				...
				try {
					...
					$Retorno = array_map( function( $input ) {
						...
						return array(
							...
							'amos_cada_tracao_1_final' => $input['amos_cada_tracao_1_final'],
							'amos_cada_tracao_2' => $input['amos_cada_tracao_2'],
							'amos_cada_tracao_2_final' => $input['amos_cada_tracao_2_final'],
							...
							'amos_cada_forne_tracao_final' => $input['amos_cada_forne_tracao_final'],
